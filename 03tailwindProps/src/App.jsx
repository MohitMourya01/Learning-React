...
function App() {
  ...
  return (
    <>
      ...
      {/* <Card username=" chai"  myarr = { myObj } />
      <Card /> */}
       ...
       <div className="w-full h-screen duration-200"
          ...
          <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
            <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
              ...
              <button onClick={()=> setColor("white")} className='outline-none px-4 py-1 rounded-full text-black shadow-lg' style={{backgroundColor:"milk"}}>Milk</button>
              ...
              <button onClick={()=> setColor("#025")} className='outline-none px-4 py-1 rounded-full text-white shadow-lg' style={{backgroundColor:"#025"}}>Navy</button>
